...
public final class StdIn {
	...
	public static double readDouble() {
		try {
			...
			throw new NoSuchElementException("attempts to read a 'double' "
			                                 + "value from standard input, "
			                                 + "but no more tokens "
			                                 + "are available");
		}
	...
	public static float readFloat() {
		try {
			...
			throw new NoSuchElementException("attempts to read a 'float' "
			                                 + "value from standard input, "
			                                 + "but there no more "
	...
	public static long readLong() {
		try {
			...
			throw new NoSuchElementException("attempts to read a 'long' "
			                                 + "value from standard input, "
			                                 + "but no more "
			                                 + "tokens are available");
		}
	...
	/**
	  ...
	  * @throws NoSuchElementException if standard input is empty
	  * @throws InputMismatchException if the next token
	  * cannot be parsed as a {@code short}
	  */
	public static short readShort() {
		try {
			...
			throw new NoSuchElementException("attempts to read a 'short' "
			                                 + "value from standard input, "
			                                 + "but no more "
			                                 + "tokens are available");
		}
	...
	public static byte readByte() {
		try {
			...
			throw new NoSuchElementException("attempts to read a 'byte' "
			                                 + "value from standard input, "
			                                 + "but no more tokens "
			                                 + "are available");
		}
	 ...
	 *    be parsed as a {@code boolean}:
	 *    {@code true} or {@code 1} for true, and {false} or {0} for false,
	 *    ignoring case
	 */
